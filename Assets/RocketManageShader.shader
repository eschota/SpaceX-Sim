...
Shader "Unlit/RocketManageShader"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				surfaceDescription.Color = ase_screenPosNorm.xyz;
