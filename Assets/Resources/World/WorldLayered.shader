...
Shader "WorldLayered"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float lerpResult59 = lerp( simplePerlin2D58 , 0.0 , ( temp_output_53_0 < 0.95 ? 1.0 : 0.8 ));
			float temp_output_60_0 = ( lerpResult59 * 0.01 );
			o.Alpha = ( ( 1.0 - tex2D( _HologramDistort, ( ase_screenPosNorm + float4( uv_TexCoord45, 0.0 , 0.0 ) ).xy ) ) + temp_output_60_0 ).r;
		}
...
/*ASEBEGIN
Version=18712
83;186;1424;714;-564.7258;-2135.242;1;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;40;121.4491,1407.571;Inherit;False;1544.499;519.1493;Comment;10;50;49;48;47;46;45;44;43;42;41;Opacity;0.4056491,1,0.08962262,1;0;0
...
Node;AmplifyShaderEditor.ColorNode;6;621.2894,-561.4408;Inherit;False;Property;_ColorTint;Color Tint;7;0;Create;True;0;0;0;False;0;False;0.8867924,0.2300641,0.2300641,0;1,0.04160944,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;36;-379.9517,710.0151;Inherit;True;Property;_PatternC;PatternC;2;0;Create;True;0;0;0;False;0;False;55e1aa774c84c84428a10b54249515b5;133b701d59fc4754e92229cafd21b8c0;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.OneMinusNode;50;1491.98,1461.553;Inherit;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=D75279C8854634DFC044E7CD69F84CAEAA42438F