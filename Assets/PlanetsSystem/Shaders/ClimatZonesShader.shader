...
Shader "Unlit/ClimatZonesShader"
{
	Properties
	{
		_OceanLevel("OceanLevel", Range( 0 , 1)) = 0
	...
	LOD 100
		...
		Pass
		{
			...
			float3 MyCustomExpression48( int RenderID, float4 BaseMap, float4 MaskMap, float3 NormalMap, float3 HeightMap, float3 EmissiveMap )
			{
				switch (RenderID)
				{
					case 0:
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float3 localMyCustomExpression48 = MyCustomExpression48( RenderID48 , BaseMap48 , MaskMap48 , NormalMap48 , HeightMap48 , EmissiveMap48 );
...
/*ASEBEGIN
Version=18912
0;0;2560;1371;2025.595;892.1669;1.613943;True;True
Node;AmplifyShaderEditor.IntNode;37;-47.32379,-49.23401;Inherit;False;Property;_RenderID;RenderID;5;0;Create;True;0;0;0;False;0;False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.ColorNode;61;-2032.401,515.801;Inherit;False;Constant;_ColorBlack;ColorBlack;6;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;59;-2021.401,699.801;Inherit;False;Constant;_ColorOcean;ColorOcean;6;0;Create;True;0;0;0;False;0;False;0,0.3903246,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;30;-2091.85,374.8118;Inherit;False;Property;_OceanLevel;OceanLevel;3;0;Create;True;0;0;0;True;0;False;0;0.3176471;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;60;-1561.401,627.801;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ClampOpNode;32;-1725.137,236.2117;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;31;-2111.136,158.2117;Inherit;True;Property;_TextureSample0;Texture Sample 0;1;0;Create;True;0;0;0;False;0;False;-1;fe41fb262c955084ab44b9e21776a55e;fe41fb262c955084ab44b9e21776a55e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TFHCRemapNode;62;-1443.401,266.801;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=DAA4C568A5D5B23452298A23193BBEF6D157DA1A