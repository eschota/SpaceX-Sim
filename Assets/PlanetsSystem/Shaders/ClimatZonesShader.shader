	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				#endif
				float simplePerlin3D11 = snoise( float3( i.ase_texcoord1.xy ,  0.0 )*22.0 );
				simplePerlin3D11 = simplePerlin3D11*0.5 + 0.5;
				float2 temp_cast_1 = (simplePerlin3D11).xx;
				
				
				finalColor = tex2D( _base_climat_zones, temp_cast_1 );
				return finalColor;
			}
			ENDCG
		}
...
/*ASEBEGIN
Version=18912
104;143;1150.5;519;165.4016;388.7282;1.698153;True;True
...
Node;AmplifyShaderEditor.ColorNode;16;710.8453,321.0997;Inherit;False;Constant;_Color0;Color 0;1;0;Create;True;0;0;0;False;0;False;0,0.03342342,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=09A60B4CDB586B42804A1B549921BE29EE88E45B