...
Shader "Unlit/TestShader"
{
	Properties
	{
		...
		[ASEBegin]_OceanLevel1("OceanLevel", Range( 0 , 1)) = 0.2588235
		[ASEEnd]_RenderID("RenderID", Int) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			#endif
			CBUFFER_END
			UNITY_INSTANCING_BUFFER_START(UnlitTestShader)
				UNITY_DEFINE_INSTANCED_PROP(float, _OceanLevel1)
			UNITY_INSTANCING_BUFFER_END(UnlitTestShader)
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float _OceanLevel1_Instance = UNITY_ACCESS_INSTANCED_PROP(UnlitTestShader,_OceanLevel1);
				...
				surfaceDescription.Color = localMyCustomExpression48;
...
ASEEND*/
//CHKSM=AA059AF0E4211DDE52C8417411819F241B822D65