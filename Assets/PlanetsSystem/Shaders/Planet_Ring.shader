	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				Gradient gradient11 = NewGradient( 0, 8, 8, float4( 0, 0, 0, 0.002944991 ), float4( 1, 1, 1, 0.08529793 ), float4( 0, 0, 0, 0.3117723 ), float4( 0.9150943, 0.9150943, 0.9150943, 0.4617685 ), float4( 0.2631478, 0.2631478, 0.2631478, 0.5882353 ), float4( 1, 1, 1, 0.6882429 ), float4( 1, 1, 1, 0.9264668 ), float4( 0, 0, 0, 1 ), float2( 0, 0 ), float2( 1, 0.09117266 ), float2( 0, 0.3117723 ), float2( 1, 0.4647135 ), float2( 0.7411765, 0.6941177 ), float2( 0, 0.80589 ), float2( 1, 0.9294118 ), float2( 0, 1 ) );
				float2 temp_cast_0 = (_Float1).xx;
				float2 texCoord13 = packedInput.ase_texcoord5.xy * float2( -0.65,1.1 ) + temp_cast_0;
				float2 temp_cast_1 = (_Float0).xx;
				float2 texCoord19 = packedInput.ase_texcoord5.xy * float2( 1,2.54 ) + temp_cast_1;
				float4 temp_output_23_0 = ( _Color0 * ( SampleGradient( gradient11, texCoord13.y ) * SampleGradient( gradient11, texCoord19.y ) ) );
				
				surfaceDescription.BaseColor = temp_output_23_0.rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				Gradient gradient11 = NewGradient( 0, 8, 8, float4( 0, 0, 0, 0.002944991 ), float4( 1, 1, 1, 0.08529793 ), float4( 0, 0, 0, 0.3117723 ), float4( 0.9150943, 0.9150943, 0.9150943, 0.4617685 ), float4( 0.2631478, 0.2631478, 0.2631478, 0.5882353 ), float4( 1, 1, 1, 0.6882429 ), float4( 1, 1, 1, 0.9264668 ), float4( 0, 0, 0, 1 ), float2( 0, 0 ), float2( 1, 0.09117266 ), float2( 0, 0.3117723 ), float2( 1, 0.4647135 ), float2( 0.7411765, 0.6941177 ), float2( 0, 0.80589 ), float2( 1, 0.9294118 ), float2( 0, 1 ) );
				float2 temp_cast_0 = (_Float1).xx;
				float2 texCoord13 = packedInput.ase_texcoord.xy * float2( -0.65,1.1 ) + temp_cast_0;
				float2 temp_cast_1 = (_Float0).xx;
				float2 texCoord19 = packedInput.ase_texcoord.xy * float2( 1,2.54 ) + temp_cast_1;
				float4 temp_output_23_0 = ( _Color0 * ( SampleGradient( gradient11, texCoord13.y ) * SampleGradient( gradient11, texCoord19.y ) ) );
		...
		Pass
		{
					...
					)
			{
				...
				Gradient gradient11 = NewGradient( 0, 8, 8, float4( 0, 0, 0, 0.002944991 ), float4( 1, 1, 1, 0.08529793 ), float4( 0, 0, 0, 0.3117723 ), float4( 0.9150943, 0.9150943, 0.9150943, 0.4617685 ), float4( 0.2631478, 0.2631478, 0.2631478, 0.5882353 ), float4( 1, 1, 1, 0.6882429 ), float4( 1, 1, 1, 0.9264668 ), float4( 0, 0, 0, 1 ), float2( 0, 0 ), float2( 1, 0.09117266 ), float2( 0, 0.3117723 ), float2( 1, 0.4647135 ), float2( 0.7411765, 0.6941177 ), float2( 0, 0.80589 ), float2( 1, 0.9294118 ), float2( 0, 1 ) );
				float2 temp_cast_0 = (_Float1).xx;
				float2 texCoord13 = packedInput.ase_texcoord1.xy * float2( -0.65,1.1 ) + temp_cast_0;
				float2 temp_cast_1 = (_Float0).xx;
				float2 texCoord19 = packedInput.ase_texcoord1.xy * float2( 1,2.54 ) + temp_cast_1;
				float4 temp_output_23_0 = ( _Color0 * ( SampleGradient( gradient11, texCoord13.y ) * SampleGradient( gradient11, texCoord19.y ) ) );
		...
		Pass
		{
					...
					)
			{
				...
				Gradient gradient11 = NewGradient( 0, 8, 8, float4( 0, 0, 0, 0.002944991 ), float4( 1, 1, 1, 0.08529793 ), float4( 0, 0, 0, 0.3117723 ), float4( 0.9150943, 0.9150943, 0.9150943, 0.4617685 ), float4( 0.2631478, 0.2631478, 0.2631478, 0.5882353 ), float4( 1, 1, 1, 0.6882429 ), float4( 1, 1, 1, 0.9264668 ), float4( 0, 0, 0, 1 ), float2( 0, 0 ), float2( 1, 0.09117266 ), float2( 0, 0.3117723 ), float2( 1, 0.4647135 ), float2( 0.7411765, 0.6941177 ), float2( 0, 0.80589 ), float2( 1, 0.9294118 ), float2( 0, 1 ) );
				float2 temp_cast_0 = (_Float1).xx;
				float2 texCoord13 = packedInput.ase_texcoord3.xy * float2( -0.65,1.1 ) + temp_cast_0;
				float2 temp_cast_1 = (_Float0).xx;
				float2 texCoord19 = packedInput.ase_texcoord3.xy * float2( 1,2.54 ) + temp_cast_1;
				float4 temp_output_23_0 = ( _Color0 * ( SampleGradient( gradient11, texCoord13.y ) * SampleGradient( gradient11, texCoord19.y ) ) );
		...
		Pass
		{
						...
						)
			{
				...
				Gradient gradient11 = NewGradient( 0, 8, 8, float4( 0, 0, 0, 0.002944991 ), float4( 1, 1, 1, 0.08529793 ), float4( 0, 0, 0, 0.3117723 ), float4( 0.9150943, 0.9150943, 0.9150943, 0.4617685 ), float4( 0.2631478, 0.2631478, 0.2631478, 0.5882353 ), float4( 1, 1, 1, 0.6882429 ), float4( 1, 1, 1, 0.9264668 ), float4( 0, 0, 0, 1 ), float2( 0, 0 ), float2( 1, 0.09117266 ), float2( 0, 0.3117723 ), float2( 1, 0.4647135 ), float2( 0.7411765, 0.6941177 ), float2( 0, 0.80589 ), float2( 1, 0.9294118 ), float2( 0, 1 ) );
				float2 temp_cast_0 = (_Float1).xx;
				float2 texCoord13 = packedInput.ase_texcoord7.xy * float2( -0.65,1.1 ) + temp_cast_0;
				float2 temp_cast_1 = (_Float0).xx;
				float2 texCoord19 = packedInput.ase_texcoord7.xy * float2( 1,2.54 ) + temp_cast_1;
				float4 temp_output_23_0 = ( _Color0 * ( SampleGradient( gradient11, texCoord13.y ) * SampleGradient( gradient11, texCoord19.y ) ) );
...
ASEEND*/
//CHKSM=547373872AA563BEAA9776AA446A0D14706E9E83