...
public class HxVolumetricShadersUsed : ScriptableObject
{
    ...
    public static void SetVolumetricValues(bool full,bool lowRes, bool heightFog, bool heightFogOff, bool noise, bool noiseOff, bool transparency, bool transparencyOff, bool densityParticles, bool point, bool spot, bool directional, bool singlePass,bool projector)
    {
        ...
        if (!BuildPipeline.isBuildingPlayer)
        {
            if (instance == null)
            {
                instance = AssetDatabase.LoadAssetAtPath("Assets/Plugins/HxVolumetricLighting/Resources/HxUsedShaders.asset", typeof(HxVolumetricShadersUsed)) as HxVolumetricShadersUsed;

                if (instance == null)
                {
                    instance = ScriptableObject.CreateInstance<HxVolumetricShadersUsed>();
                    AssetDatabase.CreateAsset(instance, "Assets/Plugins/HxVolumetricLighting/Resources/HxUsedShaders.asset");
    ...
    static public void ForceBuild()
    {
        if (instance == null)
        {
            ...
            if (instance == null)
            {
                ...
                AssetDatabase.CreateAsset(instance, "Assets/Plugins/HxVolumetricLighting/Resources/HxUsedShaders.asset");
                AssetDatabase.SaveAssets();
                // instance = AssetDatabase.LoadAssetAtPath("Assets/Plugins/HxVolumetricLighting/HxUsedShaders.asset", typeof(HxVolumetricShadersUsed)) as GameObject;
            }
        }
