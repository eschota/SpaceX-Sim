...
Shader "Hologram"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float simplePerlin2D69 = snoise( temp_cast_1*20.27 );
			float lerpResult68 = lerp( simplePerlin2D69 , 0.0 , ( temp_output_63_0 < 0.9 ? 1.0 : 0.0 ));
			float3 temp_cast_2 = (( lerpResult68 * 0.01 )).xxx;
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float fresnelNode54 = ( 0.0 + 4.0 * pow( 1.0 - fresnelNdotV54, 2.0 ) );
			...
			float4 tex2DNode41 = tex2D( _Texture0, ( ase_screenPosNorm + float4( uv_TexCoord44, 0.0 , 0.0 ) ).xy );
			float2 temp_cast_3 = (_Time.y).xx;
			float dotResult4_g1 = dot( temp_cast_3 , float2( 12.9898,78.233 ) );
			float lerpResult10_g1 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g1 ) * 43758.55 ) ));
			float temp_output_63_0 = lerpResult10_g1;
			o.Emission = ( ( tex2D( _Primarylayerimage, uv_Primarylayerimage ) * ( ( lerpResult59 + ( ( 1.0 - tex2DNode41 ) * _Color0 ) ) * ( temp_output_63_0 > 0.97 ? 1.0 : 0.8 ) ) ) * _powerEmission ).rgb;
			o.Alpha = tex2DNode41.r;
		}
...
/*ASEBEGIN
Version=18712
2125;55;1200;909;-2587.805;-215.9103;1.3;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;50;279.9416,1403.328;Inherit;False;Property;_speed;speed;3;0;Create;True;0;0;0;False;0;False;0;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;42;901.4128,1053.858;Inherit;True;Property;_Texture0;Texture 0;1;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.FresnelNode;54;1357.418,467.626;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;4;False;3;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;53;1358.518,173.8414;Inherit;False;Property;_frenel;frenel;5;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;43;1631.333,470.9957;Inherit;False;Property;_Color0;Color 0;2;0;Create;True;0;0;0;False;0;False;0.4878055,0.7924528,0.3102527,0;0.4878055,0.7924528,0.3102527,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleTimeNode;64;1780.902,1407.96;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;60;1755.772,1068.436;Inherit;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;78;2453.892,1506.908;Inherit;False;Constant;_Float0;Float 0;11;0;Create;True;0;0;0;False;0;False;20.27;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Compare;65;2185.902,1401.96;Inherit;True;2;4;0;FLOAT;0;False;1;FLOAT;0.97;False;2;FLOAT;1;False;3;FLOAT;0.8;False;1;FLOAT;0
Node;AmplifyShaderEditor.Compare;70;2196.717,1653.317;Inherit;True;4;4;0;FLOAT;0;False;1;FLOAT;0.9;False;2;FLOAT;1;False;3;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;66;2460.479,318.7695;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;80;3615.188,1812.042;Inherit;False;Constant;_Float1;Float 1;11;0;Create;True;0;0;0;False;0;False;0.01;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;82;3362.48,860.4056;Inherit;False;Property;_powerEmission;powerEmission;6;0;Create;True;0;0;0;False;0;False;1;10.8;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;28;4093.425,866.678;Float;False;True;-1;6;ASEMaterialInspector;0;0;Unlit;Hologram;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Transparent;0.71;True;False;0;False;Transparent;;Transparent;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;False;2;5;False;-1;10;False;-1;8;5;False;-1;1;False;-1;1;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;28;9;41;0
WireConnection;28;11;79;0
ASEEND*/
//CHKSM=C0DFBF537B622BE0609427D8799DF2103C87280F