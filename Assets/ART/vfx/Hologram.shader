...
Shader "Hologram"
{
	Properties
	{
		...
		[ASEBegin]_Primarylayerimage("Primary layer image", 2D) = "white" {}
		_Texture0("Texture 0", 2D) = "white" {}
		_Color0("Color 0", Color) = (0.4878055,0.7924528,0.3102527,0)
		_speed("speed", Float) = 0
		_Tiling("Tiling", Vector) = (1,1,0,0)
		_frenel("frenel", Color) = (0,0,0,0)
		[ASEEnd]_powerEmission("powerEmission", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _Primarylayerimage_ST;
			float4 _frenel;
			float4 _Color0;
			float2 _Tiling;
			float _speed;
			float _powerEmission;
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float mulTime64 = _TimeParameters.x * 0.1;
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 uv_Primarylayerimage = packedInput.ase_texcoord1.xy * _Primarylayerimage_ST.xy + _Primarylayerimage_ST.zw;
				float3 ase_worldNormal = packedInput.ase_texcoord2.xyz;
				float fresnelNdotV54 = dot( ase_worldNormal, V );
				...
				float2 texCoord44 = packedInput.ase_texcoord1.xy * _Tiling + temp_cast_0;
				float4 temp_output_60_0 = ( 1.0 - tex2D( _Texture0, ( ase_screenPosNorm + float4( texCoord44, 0.0 , 0.0 ) ).xy ) );
				float mulTime64 = _TimeParameters.x * 0.1;
				float2 temp_cast_3 = (mulTime64).xx;
				float dotResult4_g1 = dot( temp_cast_3 , float2( 12.9898,78.233 ) );
				float lerpResult10_g1 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g1 ) * 43758.55 ) ));
				float temp_output_63_0 = lerpResult10_g1;
				float4 temp_output_81_0 = ( tex2D( _Primarylayerimage, uv_Primarylayerimage ) * ( ( lerpResult59 + ( temp_output_60_0 * _Color0 ) ) * ( temp_output_63_0 > 0.98 ? 1.0 : 0.8 ) ) );
				float4 lerpResult93 = lerp( temp_output_81_0 , temp_output_60_0 , temp_output_81_0);
				float4 temp_output_83_0 = ( lerpResult93 * _powerEmission );
				
				surfaceDescription.Color = temp_output_83_0.rgb;
				surfaceDescription.Emission = temp_output_83_0.rgb;
				surfaceDescription.Alpha = lerpResult93.r;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 uv_Primarylayerimage = packedInput.ase_texcoord.xy * _Primarylayerimage_ST.xy + _Primarylayerimage_ST.zw;
				...
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 temp_cast_0 = (( _TimeParameters.x * _speed )).xx;
				float2 texCoord44 = packedInput.ase_texcoord.xy * _Tiling + temp_cast_0;
				float4 temp_output_60_0 = ( 1.0 - tex2D( _Texture0, ( ase_screenPosNorm + float4( texCoord44, 0.0 , 0.0 ) ).xy ) );
				float mulTime64 = _TimeParameters.x * 0.1;
				float2 temp_cast_3 = (mulTime64).xx;
				float dotResult4_g1 = dot( temp_cast_3 , float2( 12.9898,78.233 ) );
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 uv_Primarylayerimage = packedInput.ase_texcoord3.xy * _Primarylayerimage_ST.xy + _Primarylayerimage_ST.zw;
				...
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 temp_cast_0 = (( _TimeParameters.x * _speed )).xx;
				float2 texCoord44 = packedInput.ase_texcoord3.xy * _Tiling + temp_cast_0;
				float4 temp_output_60_0 = ( 1.0 - tex2D( _Texture0, ( ase_screenPosNorm + float4( texCoord44, 0.0 , 0.0 ) ).xy ) );
				float mulTime64 = _TimeParameters.x * 0.1;
				float2 temp_cast_3 = (mulTime64).xx;
				float dotResult4_g1 = dot( temp_cast_3 , float2( 12.9898,78.233 ) );
...
/*ASEBEGIN
Version=18712
166;459;1424;690;-2623.245;-547.1181;1.3;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;50;279.9416,1403.328;Inherit;False;Property;_speed;speed;3;0;Create;True;0;0;0;False;0;False;0;0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;42;901.4128,1053.858;Inherit;True;Property;_Texture0;Texture 0;1;0;Create;True;0;0;0;False;0;False;None;d288b8940e5ac6e42990d89cafefce73;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.ColorNode;53;1358.518,173.8414;Inherit;False;Property;_frenel;frenel;5;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,1,0.6046056,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;43;1631.333,470.9957;Inherit;False;Property;_Color0;Color 0;2;0;Create;True;0;0;0;False;0;False;0.4878055,0.7924528,0.3102527,0;0.1873899,0.1013261,0.6509434,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;4;1525.136,-78.06966;Inherit;True;Property;_Primarylayerimage;Primary layer image;0;0;Create;True;0;0;0;False;0;False;b273dbd84408a344da543d1a41388641;106d49ec43601e44f87600f3128cc257;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;83;3800.861,607.75;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;82;3385.832,860.4056;Inherit;False;Property;_powerEmission;powerEmission;6;0;Create;True;0;0;0;False;0;False;1;6.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;93;3298.269,600.0189;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;85;3502.073,1165.549;Inherit;False;Constant;_Float2;Float 2;7;0;Create;True;0;0;0;False;0;False;-0.71;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;84;3720.408,1040.461;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;89;4093.425,866.678;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;SceneSelectionPass;0;3;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-26;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=SceneSelectionPass;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;86;4093.425,866.678;Float;False;True;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;13;Hologram;7f5cb9c3ea6481f469fdd856555439ef;True;Forward Unlit;0;0;Forward Unlit;9;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Transparent=Queue=0;True;5;0;True;1;0;True;-20;0;True;-21;1;0;True;-22;0;True;-23;False;False;False;False;False;False;False;False;True;0;True;-26;False;False;False;False;True;True;0;True;-5;255;False;-1;255;True;-6;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;0;True;-24;True;0;True;-32;False;True;1;LightMode=ForwardOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;29;Surface Type;1;  Rendering Pass ;0;  Rendering Pass;1;  Blending Mode;0;  Receive Fog;1;  Distortion;0;    Distortion Mode;0;    Distortion Only;1;  Depth Write;1;  Cull Mode;0;  Depth Test;4;Double-Sided;0;Alpha Clipping;0;Motion Vectors;1;  Add Precomputed Velocity;0;Shadow Matte;0;Cast Shadows;1;DOTS Instancing;0;GPU Instancing;1;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;7;True;True;True;True;True;True;False;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;87;4093.425,866.678;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;ShadowCaster;0;1;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-26;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=ShadowCaster;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;88;4093.425,866.678;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;META;0;2;META;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;92;4093.425,866.678;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;DistortionVectors;0;6;DistortionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;4;1;False;-1;1;False;-1;4;1;False;-1;1;False;-1;True;1;False;-1;1;False;-1;False;False;False;False;False;False;False;True;0;True;-26;False;False;False;False;True;True;0;True;-11;255;False;-1;255;True;-12;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;False;True;1;LightMode=DistortionVectors;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;90;4093.425,866.678;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;DepthForwardOnly;0;4;DepthForwardOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-26;True;False;False;False;False;0;False;-1;False;False;False;True;True;0;True;-7;255;False;-1;255;True;-8;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;False;False;True;1;LightMode=DepthForwardOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;91;4093.425,866.678;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;Motion Vectors;0;5;Motion Vectors;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-26;False;False;False;False;True;True;0;True;-9;255;False;-1;255;True;-10;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;False;False;True;1;LightMode=MotionVectors;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
WireConnection;86;6;79;0
ASEEND*/
//CHKSM=680953DC3775E3BA75643A40A2C2E296C25D5C74