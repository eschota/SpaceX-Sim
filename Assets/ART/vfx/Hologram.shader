...
Shader "Hologram"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float lerpResult10_g1 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g1 ) * 43758.55 ) ));
			float temp_output_63_0 = lerpResult10_g1;
			o.Emission = ( ( tex2D( _Primarylayerimage, uv_Primarylayerimage ) * ( ( lerpResult59 + ( ( 1.0 - tex2DNode41 ) * _Color0 ) ) * ( temp_output_63_0 > 0.98 ? 1.0 : 0.8 ) ) ) * _powerEmission ).rgb;
...
/*ASEBEGIN
Version=18712
2176;155;1200;909;-2887.256;-1120.828;1.3;True;False
...
Node;AmplifyShaderEditor.ColorNode;53;1358.518,173.8414;Inherit;False;Property;_frenel;frenel;5;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.3037113,0.8859902,0.990566,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;43;1631.333,470.9957;Inherit;False;Property;_Color0;Color 0;2;0;Create;True;0;0;0;False;0;False;0.4878055,0.7924528,0.3102527,0;0.466205,0,0.9607843,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;4;1525.136,-78.06966;Inherit;True;Property;_Primarylayerimage;Primary layer image;0;0;Create;True;0;0;0;False;0;False;b273dbd84408a344da543d1a41388641;d2f6579a8183ca048bcbebe05a3f486d;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;82;3362.48,860.4056;Inherit;False;Property;_powerEmission;powerEmission;6;0;Create;True;0;0;0;False;0;False;1;6.84;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=BED3D67C749F244B6B00B26CD5F8FB8AF32D9573