...
Shader "CloudsShader"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 _CloudsBaseColor;
			half4 _Flowmapcloud_ST;
			half4 _DarkSideEmission;
			half _CloudMult;
			half _SpeedFlowmap;
			half _PowerFlow;
			half _FlowTiling;
						...
						)
			{
				...
				half2 texCoord103 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 uv_Flowmapcloud = packedInput.ase_texcoord5.xy * _Flowmapcloud_ST.xy + _Flowmapcloud_ST.zw;
				half2 blendOpSrc105 = texCoord103;
				...
				half mulTime97 = _TimeParameters.x * 0.5;
				...
				half2 lerpResult107 = lerp( texCoord103 , temp_output_105_0 , timeA108);
				half2 temp_cast_1 = (_FlowTiling).xx;
				half2 temp_cast_2 = (_FlowOffset).xx;
				half2 texCoord215 = packedInput.ase_texcoord5.xy * temp_cast_1 + temp_cast_2;
				half2 DifTiling216 = texCoord215;
				half2 flowA110 = ( lerpResult107 + DifTiling216 );
				half temp_output_1_0_g6 = (temp_output_99_0*1.0 + 0.5);
				half timeB151 = ( -(0.0 + (( ( temp_output_1_0_g6 - floor( ( temp_output_1_0_g6 + 0.5 ) ) ) * 2 ) - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)) * _PowerFlow );
				half2 lerpResult157 = lerp( texCoord103 , temp_output_105_0 , timeB151);
				half2 flowB160 = ( lerpResult157 + DifTiling216 );
				half Blend187 = saturate( abs( ( 1.0 - ( temp_output_101_0 / 0.5 ) ) ) );
				half3 lerpResult179 = lerp( UnpackNormalScale( tex2D( _NormalMap, flowA110 ), 1.0f ) , UnpackNormalScale( tex2D( _NormalMap, flowB160 ), 1.0f ) , Blend187);
				...
				half dotResult17 = dot( -_DirectionalLightDatas[0].forward , normalWS );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				half3 ase_worldNormal = TransformObjectToWorldNormal(inputMesh.normalOS);
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				half2 texCoord103 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				...
				half2 temp_cast_1 = (_FlowTiling).xx;
				half2 temp_cast_2 = (_FlowOffset).xx;
				half2 texCoord215 = packedInput.ase_texcoord.xy * temp_cast_1 + temp_cast_2;
				half2 DifTiling216 = texCoord215;
				half2 flowA110 = ( lerpResult107 + DifTiling216 );
				half temp_output_1_0_g6 = (temp_output_99_0*1.0 + 0.5);
				half timeB151 = ( -(0.0 + (( ( temp_output_1_0_g6 - floor( ( temp_output_1_0_g6 + 0.5 ) ) ) * 2 ) - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)) * _PowerFlow );
				...
				half3 ase_worldNormal = packedInput.ase_texcoord1.xyz;
				half dotResult17 = dot( -_DirectionalLightDatas[0].forward , ase_worldNormal );
				half4 temp_cast_5 = (dotResult17).xxxx;
				half4 clampResult43 = clamp( CalculateContrast(_DarkSideContrast,temp_cast_5) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				half4 Emission194 = ( _DarkSideEmission * ( 1.0 - clampResult43 ) );
		...
		Pass
		{
					...
					)
			{
				...
				half2 texCoord103 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				...
				half2 texCoord215 = packedInput.ase_texcoord3.xy * temp_cast_0 + temp_cast_1;
				half2 DifTiling216 = texCoord215;
				half2 flowA110 = ( lerpResult107 + DifTiling216 );
				half temp_output_1_0_g6 = (temp_output_99_0*1.0 + 0.5);
				half timeB151 = ( -(0.0 + (( ( temp_output_1_0_g6 - floor( ( temp_output_1_0_g6 + 0.5 ) ) ) * 2 ) - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)) * _PowerFlow );
		...
		Pass
		{
						...
						)
			{
				...
				half2 texCoord103 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				...
				half2 temp_cast_1 = (_FlowTiling).xx;
				half2 temp_cast_2 = (_FlowOffset).xx;
				half2 texCoord215 = packedInput.ase_texcoord7.xy * temp_cast_1 + temp_cast_2;
				half2 DifTiling216 = texCoord215;
				half2 flowA110 = ( lerpResult107 + DifTiling216 );
				half temp_output_1_0_g6 = (temp_output_99_0*1.0 + 0.5);
				half timeB151 = ( -(0.0 + (( ( temp_output_1_0_g6 - floor( ( temp_output_1_0_g6 + 0.5 ) ) ) * 2 ) - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)) * _PowerFlow );
...
/*ASEBEGIN
Version=18712
60;5;1854;1048;-1192.295;1102.113;1;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;212;3091.954,682.7902;Inherit;False;669.9207;740.0803;Main;7;195;119;191;197;193;77;198;;1,0,0.008262634,1;0;0
...
ASEEND*/
//CHKSM=26EBC8FBF01854E70C5659B346FF736A72A844A5