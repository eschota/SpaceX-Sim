...
Shader "Mars_atmosphere"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_AtmosphereColor("Atmosphere Color", Color) = (1,0.6627451,0.5607843,0)
		_OuterTransparency("Outer Transparency", Range( 0 , 1)) = 0.76
		_AtmosphereTransparency("Atmosphere Transparency", Range( 0 , 30)) = 6
		[ASEEnd]_DarkSideAtmosphere("DarkSide Atmosphere", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _AtmosphereTransparency;
			float _OuterTransparency;
			float _DarkSideAtmosphere;
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float clampResult13 = clamp( pow( fresnelNode7 , _AtmosphereTransparency ) , 0.0 , 1.0 );
				float clampResult10 = clamp( (0.0 + (fresnelNode7 - _OuterTransparency) * (1.0 - 0.0) / (1.0 - _OuterTransparency)) , 0.0 , 1.0 );
